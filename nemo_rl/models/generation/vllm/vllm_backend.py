...
class VllmInternalWorkerExtension:
    ...
    def _load_weights(self, weights):
        ...
        # An MX publisher sends each trainer rank's local shard, so a TP>1
        # inference worker may receive a slice that needs placing or expanding
        # before the loader sees it. This is a no-op for the other transports,
        # which always deliver whole tensors.
